...
yolo = YoloV3()
load_darknet_weights(yolo, 'C:/Users/91832/OneDrive/Desktop/B tech project work/yolo 18.weights') 
...
def webcamVideo():
    ...
    while(True):
        ...
        img = img / 255
        class_names = [c.strip() for c in open('C:/Users/91832/OneDrive/Desktop/B tech project work/Classes.txt').readlines()]
